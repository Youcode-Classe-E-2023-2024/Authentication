...
<div class="max-w-screen-xl mx-auto">
        ...
        <ul class="inline-flex items-center">
            ...
            <li class="px-2 md:px-4 hidden md:block">
                <form action="/logout" method="POST">
                    @csrf
                    <button class="text-gray-500 font-semibold hover:text-purple-500"> Logout </button>
                </form>
            </li>
        </ul>
    ...
    <main class="mt-10">
        ...
        <div class="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed">
            <p class="pb-6">Advantage old had otherwise sincerity dependent additions. It in adapted natural hastily
                is
                justice. Six draw
            ...
            <p class="pb-6">Exquisite cordially mr happiness of neglected distrusts. Boisterous impossible unaffected
                he me
                everything.
